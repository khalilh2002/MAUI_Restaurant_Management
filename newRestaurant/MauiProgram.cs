...
namespace newRestaurant
{
    public static class MauiProgram
    {
        ...
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddTransient<UserDetailViewModel>(); // <-- ADD
            ...
            builder.Services.AddTransient<TableDetailPage>(); // <-- ADD
            builder.Services.AddTransient<LoginPage>();
            builder.Services.AddTransient<UsersPage>(); // <-- ADD
            builder.Services.AddTransient<UserDetailPage>(); // <-- ADD
